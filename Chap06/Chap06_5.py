# -*- coding: utf-8 -*-
"""
Created on Tue Apr 11 11:51:25 2023
...
class Panorama(QMainWindow):
    def __init__(self):
        ...
        collectButton.setGeometry (10,10,100,30)
        self.showButton.setGeometry (110,10,100,30)
        self.stitchButton.setGeometry (210,10,100,30)
        self.removeBlackButton.setGeometry(310,10,100,30)
        self.saveButton.setGeometry (410,10,50,30)
    ...
    def removeBlackFunction(self):
        ...
        # 계산된 바운딩 박스를 기반으로 이미지를 자르기
        cropped_image = self.img_stitched[y:y+h, x:x+w]
